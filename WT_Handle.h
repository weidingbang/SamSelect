...
class WT_Handle
{
	...
	public:
		...
		vector<vector<unsigned int> > CountingAllOneMisLmer(int index_length){ return fm->CountingAllOneMisLmer(index_length); };
		void counting(const char * pattern) { fm->counting(pattern); };
